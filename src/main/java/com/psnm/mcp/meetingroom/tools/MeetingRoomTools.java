...
import org.springframework.ai.mcp.McpToolParam;
...
public class MeetingRoomTools {
    ...
    public List<OfficeDto> findAvailableRooms(
        ...
        try {
            ...
            // 실제 구현에서는 backendApiClient.findAvailableRooms(...) 호출
    ...
    public List<OfficeDto> getMyReservations() {
        ...
        try {
            ...
            // 실제 구현에서는 backendApiClient.getMyReservations(...) 호출
            return List.of(); // 실제 구현에서는 API에서 데이터 반환
    ...
    public List<OfficeDto> listOffices(
        ...
        try {
            ...
            // 실제 구현에서는 backendApiClient.findOffices(...) 호출
            return List.of(); // 실제 구현에서는 API에서 데이터 반환
